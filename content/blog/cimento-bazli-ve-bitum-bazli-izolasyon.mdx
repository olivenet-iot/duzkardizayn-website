...
excerpt: "Çimento esaslı sürme yalıtım ile bitümlü membran arasındaki gerçek farklar neler? KKTC iklimine göre hangisi nerede kullanılmalı, ikisi nasıl birlikte çalışır ve hangi hatalardan kaçınılmalı? 25 yıllık saha deneyimiyle teknik karşılaştırma rehberi."
coverImage: "/images/services/izolasyon/hero.jpg"
author: "Düzkar Dizayn"
publishedAt: "2026-06-11"
category: "İzolasyon"
tags: ["çimento bazlı izolasyon", "bitüm membran", "su yalıtımı", "kristalize yalıtım", "esnek su yalıtımı", "negatif su basıncı", "kktc", "girne", "izolasyon rehberi"]
readingTime: 13
metaTitle: "Çimento Bazlı mı Bitüm Bazlı mı İzolasyon? | Düzkar Dizayn"
metaDescription: "Çimento esaslı sürme yalıtım mı, bitümlü membran mı? KKTC iklimine göre negatif basınç, nefes alma ve çatlak köprüleme farkları, hangisi nerede kullanılır."
tableOfContents:
  - id: "giris"
    title: "Giriş"
    level: 2
  - id: "iki-yaklasim"
    title: "İki Temel Yaklaşım: Sürme ve Membran"
    level: 2
  - id: "cimento-bazli"
...
<ComparisonTable
  ...
  rows={[
    ...
    { cells: ["Islak/nemli yüzey", "Uygulanabilir (kür için nem ister)", "Uygulanamaz (kuru yüzey şart)"], highlight: true },
    ...
    { cells: ["Uygulama güvenliği", "Su esaslı, alevsiz, yanmaz", "Şaloma alevi, yangın/koku riski"] },
  ]}
/>
...
<ComparisonTable
  ...
  rows={[
    ...
    { cells: ["Radye temel ve perde dış yüz", "Bitüm membran (pozitif)", "Yüksek hidrostatik basınç + kalın bariyer"], highlight: true },
    ...
    { cells: ["İstinat duvarı (toprak altı)", "Bitüm membran (pozitif) + drenaj", "Suyun geldiği dış yüzde bariyer"] },
  ]}
/>
...
<StepByStep
  ...
  steps={[
    ...
    },
    {
      ...
      description: "Yanıcı altyapı, kapalı iç mekan veya alev kullanılamayacak bir ortam varsa çimento bazlı ya da soğuk/kendinden yapışkanlı bitüm seçilir. Zemin ıslaksa ve hemen uygulama gerekiyorsa çimento bazlı tek seçenektir."
    },
  ]}
/>
...
Bodrum perde duvarında dış (su gelen) yüze bitüm membran veya sıvı bitüm, içeride ise emniyet için negatif basınca dayanan çimento esaslı kaplama uygularız. Bu iki cepheli yaklaşım, özellikle yüksek taban suyu olan bölgelerde adeta bir sigorta görevi görür. KKTC'de [nem sorununun kök nedenleri ve çözümleri](/blog/kktcde-nem-sorunu-sebebi-ve-cozumu) üzerine yazdığımız rehberde bu çift yönlü mantığın neden gerektiğini ayrıntılandırmıştık.
