...
import { BlogLocale, blogPostHref, blogUi } from '@/lib/blog-locale';
...
export default function BlogSidebar({ post, relatedPosts = [], locale = 'tr' }: BlogSidebarProps) {
  ...
  return (
    <aside className="space-y-8">
      ...
      <div className="sticky top-24">
        <TableOfContents items={post.tableOfContents} locale={locale} />
            ...
            <ul className="space-y-3">
              {relatedPosts.map((relatedPost) => (
                <li key={relatedPost.slug}>
                  <Link
                    href={blogPostHref(relatedPost.slug, locale)}
