      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-heading font-bold text-white mb-6 reveal">
            {title}{" "}
            {highlightedText && (
              <span className="text-gold-primary">{highlightedText}</span>
            )}
          </h2>
          <p
            className="text-white/70 text-lg leading-relaxed mb-10 reveal"
          ...
          {trustBadges.length > 0 && (
            <div
              className="flex flex-wrap justify-center gap-8 mt-12 reveal"
